...
function fetchPendingServicesCount() {
    ...
    fetch('/admin/api/pending-services/count')
        .then(response => {
...
function fetchPendingServices() {
    ...
    fetch('/admin/api/pending-services')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function handleViewPendingService(serviceId) {
    ...
    fetch(`/admin/api/service/${serviceId}`)
        .then(response => {
...
function approveService() {
    ...
    fetch(`/admin/api/service/${currentServiceId}/approve`, {
        method: 'POST'
    })
...
function rejectService() {
    ...
    fetch(`/admin/api/service/${currentServiceId}/reject`, {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function fetchPendingTiffinsCount() {
    ...
    fetch('/admin/api/pending-tiffins/count')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function fetchPendingTiffins() {
    ...
    fetch('/admin/api/pending-tiffins')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function handleViewPendingTiffin(tiffinId) {
    ...
    fetch(`/admin/api/tiffin/${tiffinId}`)
        .then(response => {
...
function approveTiffin() {
    ...
    fetch(`/admin/api/tiffin/${currentTiffinId}/approve`, {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function rejectTiffin() {
    ...
    fetch(`/admin/api/tiffin/${currentTiffinId}/reject`, {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function fetchPendingHousesCount() {
    ...
    fetch('/admin/api/pending-houses/count')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function fetchPendingHouses() {
    ...
    fetch('/admin/api/pending-houses')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function approveHouse() {
    ...
    fetch(`/admin/api/house/${currentHouseId}/approve`, {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function rejectHouse() {
    ...
    fetch(`/admin/api/house/${currentHouseId}/reject`, {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function fetchPendingProvidersCount() {
    ...
    fetch('/admin/api/pending-providers/count')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function fetchPendingProviders() {
    ...
    fetch('/admin/api/pending-providers')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function handleViewPendingProvider(providerId) {
    ...
    fetch(`/admin/api/provider/${providerId}`)
        .then(response => {
...
function approveProvider() {
    ...
    fetch(`/admin/api/provider/${currentProviderId}/approve`, {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function rejectProvider() {
    ...
    fetch(`/admin/api/provider/${currentProviderId}/reject`, {
        method: 'POST'
    })
    .then(response => response.json())
    .then(data => {
...
function fetchProviderProfiles() {
    ...
    fetch('/admin/api/provider-profiles')
        .then(response => {
            if (!response.ok) {
...
function fetchHouseListings() {
    ...
    fetch('/admin/api/house-listings')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function fetchTiffinListings() {
    ...
    fetch('/admin/api/tiffin-listings')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function fetchServiceListings() {
    ...
    fetch('/admin/api/service-listings')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
...
function fetchServiceBookings() {
    ...
    fetch('/admin/api/service-bookings')
        .then(response => {
            if (!response.ok) throw new Error('Network response was not ok');
            return response.json();
        })
