document.addEventListener('DOMContentLoaded', function() {
    ...
    function populateKitchenDetails(listing, provider) {
        ...
        images.forEach((img, index) => {
            ...
            if (img) {
                imgEl.src = `/static/images/database_images/${img}`; // Assuming database_images for tiffin too
    ...
    function renderMeals(meals) {
        ...
        meals.forEach(meal => {
            ...
            const imgSrc = meal.image_path && meal.image_path !== 'placeholder.jpg' 
                ? `/static/images/database_images/${meal.image_path}` // Assuming meals in same bucket
