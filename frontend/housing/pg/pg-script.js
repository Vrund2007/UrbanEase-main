    ...
    fetch(`/housing/pg/${listingId}/details`)
        ...
        .then(data => {
            ...
            images.forEach((img, index) => {
                ...
                if (img) {
                    imgEl.src = `/images/database_images/${img}`;
            ...
            if (provider.profile_pic) {
                avatarEl.innerHTML = `<img src="/images/database_images/${provider.profile_pic}" alt="${provider.business_name}" onerror="this.parentElement.innerHTML='<i class=\\'fas fa-user\\'></i>'">`;
            } else {
